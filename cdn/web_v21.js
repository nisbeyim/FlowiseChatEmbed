  ...
  Yr = (t) => {
      ...
      E = async (e) => {
        if ((i(e), "" !== e.trim())) {
          ...
          try {
            ...
            if (s.data) {
              const { text: t, sourceDocuments: e } = s.data;
              t &&
                d((r) => [
                  ...r,
                  { message: t, sourceDocuments: e ?? [], type: "apiMessage" },
                ]);
            }
          } catch (r) {
            console.error(r),
    ...
    const L =
        "kk" === R
          ...
          ? "AI 보조"
          : "AI Assistant",
      [, _] = x(window.innerHeight),
      [T, O] = x(window.innerWidth),
      I =
        (window.addEventListener("resize", () => {
          _(window.innerHeight), O(window.innerWidth);
        }),
        768 < T());
    return (
      k(() => {
      ...
      [
        (() => {
          ...
          return (
            ...
            null != (I ? "16px 16px 0px 0px" : "0")
              ? l.style.setProperty(
                  "border-radius",
                  I ? "16px 16px 0px 0px" : "0"
                )
                                ...
                                get each() {
                                  return [
                                    ...((t) => {
                                      ...
                                      return (
                                        (s = t).sourceDocuments &&
                                          s.sourceDocuments[0].metadata
                                            .length &&
                                          (s.sourceDocuments =
                                            s.sourceDocuments.map((t) => {
                                              var e = t.metadata.reduce(
                                                (t, e) => (
                                                  (t[e.name] = e.value), t
                                                ),
                                                {}
                                        ...
                                        (t = s).sourceDocuments.forEach((t) => {
                                          P(t.metadata.source) &&
                                          !e.includes(t.metadata.source)
                                            ? (e.push(t.metadata.source),
                                              r.push(t))
                                            : P(t.metadata.source) || r.push(t);
                                        }),
                                        r
                                      );
                                    })(e),
