...
function k(t, e, r) {
  (h = j), ((t = L(t, e, !1, u)).user = !0), y ? y.push(t) : _(t);
}
function C(t, e, r) {
  return (
    (r = r ? Object.assign({}, c, r) : c),
    ((t = L(t, e, !0, 0)).observers = null),
...
const Rt = (t) => {
          ...
          return () =>
            (s()
                    ...
                    A(
                      (n) => {
                        var i = t.backgroundColor ?? "#3B81F6",
                          ...
                          a =
                            r().includes("dashboard") || r().includes("login")
                              ? "none"
                              : "",
                          l =
                            "absolute duration-200 transition w-9 " +
              ...
              : () => {
                  ...
                  return (
                    (s.$$click = () => t.toggleBot()),
                    l.style.setProperty("z-index", "3201"),
                    l.style.setProperty("bottom", "30px"),
                    l.style.setProperty("padding", "10px"),
                    ct(
                      l,
                      W(Y, {
                        get when() {
                    ...
                    A(
                      (s) => {
                        var n = t.isBotOpened ? "#55BBEB" : "#577487",
                          o = i ? a() + "px" : (t.right, e() + "px"),
                          u =
                            "/dashboard" === r() ||
                        ...
                        return (
                          n !== s._v$5 &&
                            (null != (s._v$5 = n)
                              ? l.style.setProperty("background-color", n)
                              : l.style.removeProperty("background-color")),
                          o !== s._v$6 &&
                            (null != (s._v$6 = o)
                              ? l.style.setProperty("right", o)
                              : l.style.removeProperty("right")),
                          u !== s._v$7 &&
                            (null != (s._v$7 = u)
                              ? l.style.setProperty("display", u)
                              : l.style.removeProperty("display")),
                          p !== s._v$8 && it(c, "class", (s._v$8 = p)),
                          d !== s._v$9 &&
                            (null != (s._v$9 = d)
  ...
  It = (t) => {
    const [e, r] = $(t, ["ref", "onInput"]);
    return (
      ((s = Ot()).$$input = (t) => e.onInput(t.currentTarget.value)),
        ...
        A(
          (r) => {
            var s =
                ...
                (Vt() ? "w-6 h-6 text-sm" : "w-10 h-10 text-xl"),
              n =
                "absolute top-0 left-0 " +
                (Vt() ? " w-6 h-6 text-sm" : "w-full h-full text-xl");
            return (
              s !== r._v$ && ot(t, (r._v$ = s)),
...
function re(t, e) {
  if (e) {
    if (Zt.test(t)) return t.replace(Xt, (t) => Kt[t]);
  } else if (te.test(t)) return t.replace(ee, (t) => Kt[t]);
  return t;
}
function se(t) {
  return t.replace(
...
var ne;
((ne = vt = vt || {})[(ne.space = 1)] = "space"),
  (ne[(ne.text = 2)] = "text"),
  (ne[(ne.paragraph = 3)] = "paragraph"),
  (ne[(ne.heading = 4)] = "heading"),
  (ne[(ne.listStart = 5)] = "listStart"),
  (ne[(ne.listEnd = 6)] = "listEnd"),
  (ne[(ne.looseItemStart = 7)] = "looseItemStart"),
  (ne[(ne.looseItemEnd = 8)] = "looseItemEnd"),
  (ne[(ne.listItemStart = 9)] = "listItemStart"),
  (ne[(ne.listItemEnd = 10)] = "listItemEnd"),
  (ne[(ne.blockquoteStart = 11)] = "blockquoteStart"),
  (ne[(ne.blockquoteEnd = 12)] = "blockquoteEnd"),
  (ne[(ne.code = 13)] = "code"),
  (ne[(ne.table = 14)] = "table"),
  (ne[(ne.html = 15)] = "html"),
  (ne[(ne.hr = 16)] = "hr");
class ie {
  gfm = !0;
...
class ae {
  ...
  hasRulesGfm;
  ruleCallbacks;
  constructor(t, e, r = ce.options, s) {
    if (
      ((this.staticThis = t),
      (this.links = e),
      (this.options = r),
      (this.renderer = s || this.options.renderer || new oe(this.options)),
      !this.links)
    )
  ...
  static getRulesBase() {
    ...
    return (
      ...
      (((t = {
        ...
        .getRegexp()),
      (t.reflink = new Jt(t.reflink).setGroup("inside", t._inside).getRegexp()),
      (this.rulesBase = t))
    );
  }
  ...
  static getRulesGfm() {
    ...
    return (
      this.rulesGfm ||
      ((t = this.getRulesBase()),
      (e = new Jt(t.escape).setGroup("])", "~|])").getRegexp()),
      (r = new Jt(t.text)
        .setGroup("]|", "~]|")
        .setGroup("|", "|https?://|")
        .getRegexp()),
  ...
  static getRulesBreaks() {
    ...
    return (
      ...
      (this.rulesBreaks = {
        ...e,
        br: new Jt(t.br).setGroup("{2,}", "*").getRegexp(),
        text: new Jt(e.text).setGroup("{2,}", "*").getRegexp(),
      }))
    );
  }
  setRules() {
...
class le {
  ...
  constructor(t) {
    (this.tokens = []),
      (this.token = null),
      (this.options = t || ce.options),
      (this.renderer = this.options.renderer || new oe(this.options));
  }
  static parse(t, e, r) {
    return new this(r).parse(e, t);
  }
  parse(t, e) {
    (this.inlineLexer = new ae(ae, t, this.options, this.renderer)),
...
class ce {
  ...
  static debug(t, e = this.options) {
    ...
    let s = t.slice();
    return (
      ((e = new le(e)).simpleRenderers = this.simpleRenderers),
      (e = e.debug(r, t)),
      {
        tokens: (s = s.map((t) => {
  ...
  static callParser(t, e, r) {
    ...
    return this.simpleRenderers.length
      ? (((s = new le(r)).simpleRenderers = this.simpleRenderers),
        s.parse(e, t))
      : le.parse(t, e, r);
  }
  static callMe(t) {
...
class he {
  ...
  hasRulesTables;
  constructor(t, e) {
    (this.staticThis = t), (this.options = e || ce.options), this.setRules();
  }
  static lex(t, e, r, s) {
  ...
  static getRulesBase() {
    ...
    return (
      ...
      (((t = {
        ...
        bullet: /(?:[*+-]|\d+\.)/,
        item: /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/,
      }).item = new Jt(t.item, "gm").setGroup(/bull/g, t.bullet).getRegexp()),
      (t.list = new Jt(t.list)
      ...
      (t.html = new Jt(t.html)
        .setGroup("comment", /<!--[\s\S]*?-->/)
        .setGroup("closed", /<(tag)[\s\S]+?<\/\1>/)
        .setGroup("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)
        .setGroup(/tag/g, e)
        .getRegexp()),
      (t.paragraph = new Jt(t.paragraph)
        .setGroup("hr", t.hr)
  ...
  static getRulesGfm() {
    ...
    return (
      ...
      (e.paragraph = new Jt(t.paragraph)
        .setGroup("(?!", `(?!${r}|${s}|`)
        .getRegexp()),
      (this.rulesGfm = e))
    );
...
const ue = st(
  ...
  pe =
    (ce.setOptions({ isNoP: !0 }),
    (t) => {
      let e;
      S(() => {
        e && (e.innerHTML = ce.parse(t.message));
      });
      {
        const r = ue(),
          s = r.firstChild;
  ...
  we = (nt(["click"]), Object.create(null)),
  ve =
    ((we.open = "0"),
    (we.close = "1"),
    (we.ping = "2"),
  ...
  Ee = ({ type: t, data: e }, r, s) =>
    Ae && e instanceof Blob
      ? r
        ? s(e)
        : Se(e, s)
      : ke && (e instanceof ArrayBuffer || Ce(e))
      ? r
        ? s(e)
        : Se(new Blob([e]), s)
      : s(we[t] + (e || "")),
...
const Re = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
  _e = "undefined" == typeof Uint8Array ? [] : new Uint8Array(256);
for (let t = 0; t < 64; t++) _e[Re.charCodeAt(t)] = t;
const Le = "function" == typeof ArrayBuffer,
  Te = (t, e) => {
    var r;
    return "string" != typeof t
      ? { type: "message", data: Ie(t, e) }
      : "b" === (r = t.charAt(0))
      ? { type: "message", data: Oe(t.substring(1), e) }
      : ve[r]
      ? 1 < t.length
        ? { type: ve[r], data: t.substring(1) }
        : { type: ve[r] }
      : xe;
  },
  Oe = (t, e) => {
    ...
    return Le
      ? ((r = ((t) => {
          ...
          for (e = 0; e < a; e += 4)
            (r = _e[t.charCodeAt(e)]),
              (s = _e[t.charCodeAt(e + 1)]),
              (n = _e[t.charCodeAt(e + 2)]),
              (i = _e[t.charCodeAt(e + 3)]),
              (h[l++] = (r << 2) | (s >> 4)),
              (h[l++] = ((15 & s) << 4) | (n >> 2)),
              (h[l++] = ((3 & n) << 6) | (63 & i));
          return c;
...
function Ne() {
  return new TransformStream({
    transform(t, e) {
      !(function (t, e) {
        Ae && t.data instanceof Blob
          ? t.data.arrayBuffer().then(Be).then(e)
          : ke && (t.data instanceof ArrayBuffer || Ce(t.data))
          ? e(Be(t.data))
          : Ee(t, !1, (t) => {
              (Pe = Pe || new TextEncoder()), e(Pe.encode(t));
            });
      })(t, (r) => {
        var s,
          n = r.length;
...
function Fe(t) {
  if (t)
    return (function (t) {
      for (var e in Fe.prototype) t[e] = Fe.prototype[e];
      return t;
    })(t);
}
(Fe.prototype.on = Fe.prototype.addEventListener =
  ...
  (Fe.prototype.hasListeners = function (t) {
...
function Ge(t, e) {
  e.useNativeTimers
    ? ((t.setTimeoutFn = De.bind(ze)), (t.clearTimeoutFn = Ve.bind(ze)))
...
class Qe extends Fe {
  ...
  onError(t, e, r) {
    return super.emitReserved("error", new $e(t, e, r)), this;
  }
  open() {
...
function er(t) {
  let e = "";
  for (; (e = Ye[t % Je] + e), 0 < (t = Math.floor(t / Je)); );
  return e;
}
function rr() {
  var t = er(+new Date());
  return t !== Xe ? ((Ke = 0), (Xe = t)) : t + "." + er(Ke++);
}
for (; tr < Je; tr++) Ze[Ye[tr]] = tr;
let sr = !1;
try {
  sr =
...
function ir(t) {
  t = t.xdomain;
  try {
    if ("undefined" != typeof XMLHttpRequest && (!t || nr))
...
function or() {}
const ar = null != new ir({ xdomain: !1 }).responseType;
class lr extends Fe {
  constructor(t, e) {
    super(),
      Ge(this, e),
  ...
  create() {
    ...
    "undefined" != typeof document &&
      ((this.index = lr.requestsCount++), (lr.requests[this.index] = this));
  }
  onError(t) {
  ...
  cleanup(t) {
    if (void 0 !== this.xhr && null !== this.xhr) {
      if (((this.xhr.onreadystatechange = or), t))
        try {
          this.xhr.abort();
        } catch (t) {}
      "undefined" != typeof document && delete lr.requests[this.index],
        (this.xhr = null);
    }
  }
  onLoad() {
...
if (
  ((lr.requestsCount = 0), (lr.requests = {}), "undefined" != typeof document)
)
  if ("function" == typeof attachEvent) attachEvent("onunload", cr);
  else if ("function" == typeof addEventListener) {
    addEventListener("onpagehide" in ze ? "pagehide" : "unload", cr, !1);
  }
function cr() {
  for (var t in lr.requests)
    lr.requests.hasOwnProperty(t) && lr.requests[t].abort();
}
const hr =
    "function" == typeof Promise && "function" == typeof Promise.resolve
      ? (t) => Promise.resolve().then(t)
      : (t, e) => e(t, 0),
  ur = ze.WebSocket || ze.MozWebSocket,
  pr =
    ...
    websocket: class extends Qe {
      ...
      doOpen() {
        if (this.check()) {
          ...
          try {
            this.ws = pr ? new ur(t, e, r) : e ? new ur(t, e) : new ur(t);
          } catch (t) {
      ...
      uri() {
        var t = this.opts.secure ? "wss" : "ws",
          e = this.query || {};
        return (
          this.opts.timestampRequests && (e[this.opts.timestampParam] = rr()),
        ...
        "function" == typeof WebTransport &&
          ...
          this.transport.ready.then(() => {
            this.transport.createBidirectionalStream().then((t) => {
                  ...
                  transform(o, a) {
                    for (r.push(o); ; ) {
                      if (0 === s) {
                        ...
                        if (He(r) < n) break;
                        (h = Me(r, n)),
                          a.enqueue(Te(i ? h : qe.decode(h), e)),
                          (s = 0);
                      }
                      if (0 === n || n > t) {
                        a.enqueue(xe);
              ...
              (e = Ne()).readable.pipeTo(t.writable),
  ...
  constructor(t, e = {}) {
    super(),
      ...
      t
        ...
        : e.host && (e.hostname = br(e.host).host),
      Ge(this, e),
      (this.secure =
        null != e.secure
          ? e.secure
  ...
  getWritablePackets() {
    if (
      ...
      for (let r = 0; r < this.writeBuffer.length; r++) {
        ...
        if ((t && (e += Ue(t)), 0 < r && e > this.maxPayload))
...
const yr = "function" == typeof ArrayBuffer,
  ...
  xr =
    "function" == typeof Blob ||
    ("undefined" != typeof Blob &&
      "[object BlobConstructor]" === vr.call(Blob)),
  Ar =
    "function" == typeof File ||
    ("undefined" != typeof File &&
      "[object FileConstructor]" === vr.call(File));
function kr(t) {
  return (
    (yr && (t instanceof ArrayBuffer || wr(t))) ||
    (xr && t instanceof Blob) ||
    (Ar && t instanceof File)
  );
}
function Cr(t, e) {
  if (t && "object" == typeof t)
    if (Array.isArray(t)) {
      for (let e = 0, r = t.length; e < r; e++) if (Cr(t[e])) return !0;
    } else {
      if (kr(t)) return !0;
      if (t.toJSON && "function" == typeof t.toJSON && 1 === arguments.length)
        return Cr(t.toJSON(), !0);
      for (const e in t)
        if (Object.prototype.hasOwnProperty.call(t, e) && Cr(t[e])) return !0;
    }
  return !1;
}
function Er(t) {
  var e = [],
    r = t.data;
  return (
    (t.data = Sr(r, e)), (t.attachments = e.length), { packet: t, buffers: e }
  );
}
function Sr(t, e) {
  if (!t) return t;
  var r;
  if (kr(t)) return (r = { _placeholder: !0, num: e.length }), e.push(t), r;
  if (Array.isArray(t)) {
    var s = new Array(t.length);
    for (let r = 0; r < t.length; r++) s[r] = Sr(t[r], e);
    return s;
  }
  if ("object" != typeof t || t instanceof Date) return t;
  var n = {};
  for (const r in t)
    Object.prototype.hasOwnProperty.call(t, r) && (n[r] = Sr(t[r], e));
  return n;
}
function Br(t, e) {
  return (t.data = Pr(t.data, e)), delete t.attachments, t;
}
function Pr(t, e) {
  if (t) {
    ...
    if (Array.isArray(t)) for (let r = 0; r < t.length; r++) t[r] = Pr(t[r], e);
    else if ("object" == typeof t)
      for (const r in t)
        Object.prototype.hasOwnProperty.call(t, r) && (t[r] = Pr(t[r], e));
  }
  return t;
}
const Rr = [
  ...
  add(t) {
    ...
    if ("string" == typeof t) {
      ...
      ((!r && e.type !== xt.BINARY_ACK) ||
        ...
        (this.reconstructor = new Tr(e)),
        0 === e.attachments)) &&
        super.emitReserved("decoded", e);
    } else {
      if (!kr(t) && !t.base64) throw new Error("Unknown type: " + t);
      if (!this.reconstructor)
  ...
  static isPayloadValid(t, e) {
    switch (t) {
      ...
      case xt.CONNECT_ERROR:
        return "string" == typeof e || _r(e);
      case xt.EVENT:
      case xt.BINARY_EVENT:
        return (
          Array.isArray(e) &&
          ("number" == typeof e[0] ||
            ("string" == typeof e[0] && -1 === Rr.indexOf(e[0])))
        );
      case xt.ACK:
      case xt.BINARY_ACK:
  ...
  takeBinaryData(t) {
    return (
      ...
      this.buffers.length === this.reconPack.attachments
        ? ((t = Br(this.reconPack, this.buffers)),
...
var Or = Object.freeze({
  ...
  Encoder: class {
    ...
    encode(t) {
      return (t.type !== xt.EVENT && t.type !== xt.ACK) || !Cr(t)
...
class Nr extends Fe {
  ...
  subEvents() {
    ...
    this.subs ||
      ((t = this.io),
      (this.subs = [
        Ir(t, "open", this.onopen.bind(this)),
        Ir(t, "packet", this.onpacket.bind(this)),
        Ir(t, "error", this.onerror.bind(this)),
        Ir(t, "close", this.onclose.bind(this)),
      ]));
  }
  get active() {
    return !!this.subs;
...
class Hr extends Fe {
  ...
  onopen() {
    ...
    var t = this.engine;
    this.subs.push(
      Ir(t, "ping", this.onping.bind(this)),
      Ir(t, "data", this.ondata.bind(this)),
      Ir(t, "error", this.onerror.bind(this)),
      Ir(t, "close", this.onclose.bind(this)),
  ...
  socket(t, e) {
    ...
    return (
      r
        ...
        : ((r = new Nr(this, t, e)), (this.nsps[t] = r)),
      r
    );
  }
  _destroy(t) {
...
function Fr(t, e) {
  ...
  var r = t.source,
    s = t.id,
    n = t.path;
  n = Mr[s] && n in Mr[s].nsps;
  let i;
  return (
    (i = (n =
      e.forceNew || e["force new connection"] || !1 === e.multiplex || n)
      ? new Hr(r, e)
      : (Mr[s] || (Mr[s] = new Hr(r, e)), Mr[s])),
    t.query && !e.query && (e.query = t.queryKey),
    i.socket(t.path, e)
  );
}
Object.assign(Fr, { Manager: Hr, Socket: Nr, io: Fr, connect: Fr });
const zr = st("<style>"),
  Wr = st(
...
const Vr = (t) => {
    let e;
    const [r] = $(t, ["onOpen", "onClose", "isOpen", "value"]),
      [s, n] =
        (S(() => {
          e &&
  ...
  Jr = (t) => {
    return (
      (e = $r()), "function" == typeof (r = t.ref) ? lt(r, e) : (t.ref = e), e
    );
    var e, r;
  },
  Zr = st("<style>"),
...
const ts = (t) => {
    const [e] = $(t, ["theme"]),
      ...
      [n, i] = x(!1),
      o = () => {
        s(!1), Kr()() < 768 && (document.body.style.overflow = "visible");
      },
      a = () => {
        r()
          ? o()
          : (n() || i(!0),
            s(!0),
            Kr()() < 768 && (document.body.style.overflow = "hidden"));
      };
    var l;
...
const as =
  ("undefined" != typeof window &&
    (yt("flowise-fullchatbot", wt, ss), yt("flowise-chatbot", wt, ts)),
  { initFull: ns, init: is, data: new os() });
((t) => {
